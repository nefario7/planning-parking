...
string PARKING_MAP_CSV = "./maps/" + MAP_NAME + "_traversability_map.csv";
string PRIMITIVES_JSON = "./python/mprims_dubin.json";
string WAYPOINT_TXT = "./waypoints/" + MAP_NAME + "_map_wp.txt";
string PARKING_WAYPOINT_TXT = "./waypoints/" + MAP_NAME + "_map_parkwp.txt";
string ROBOTPOINT_TXT = "./waypoints/" + MAP_NAME + "_map_rp.txt";
...
int main(int argc, char** argv) {
    ...
    Planner parking_planner(m, vector<float>{0.5, 1.0, 1.5, 2.0}, 50000, true);
